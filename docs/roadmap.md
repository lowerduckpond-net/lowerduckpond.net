...
| 3: Static tenant MVP | Current | M3.0 qualification through M3.4 hostile-ZIP and portable-bundle implementation are complete; M3.5 dark-host installation is next. |
...
archive-worker sandbox contract are complete. M3.5 dark-host installation is
next. Production remains disabled, and Milestone 3 remains incomplete until

...
QUALIFICATION_ENVIRONMENT = {
    ...
    "M3_QUALIFICATION_EXPECTED_ADMIN_SOURCE_CIDRS_JSON": '["192.0.2.1/32"]',
    "M3_QUALIFICATION_ORIGIN_PULL_TRUST": "dual",
    "M3_QUALIFICATION_PRIMARY_CA_PATH": "/var/empty/primary-ca.pem",
    "M3_QUALIFICATION_REPLACEMENT_CA_PATH": "/var/empty/replacement-ca.pem",
}

...
@pytest.mark.parametrize(
    ...
    [
        ...
        "scripts/qualification_failure.py",
        "scripts/qualification_case.py",
        "scripts/qualification_context.py",
        "scripts/qualification_local.py",
        "scripts/qualification_probe.py",
